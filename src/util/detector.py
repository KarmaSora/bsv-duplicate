...
def detect_duplicates(data: str) -> list[str]:
    """Detect duplcate article entries in a raw text file containing bibliographic references 
    in BibTeX format. Two articles are considered duplicates if they have the same key 
